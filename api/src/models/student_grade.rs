...
impl TryFrom<(student_grades::Model, String)> for StudentGradeView {
    ...
    fn try_from(
        ...
        Ok(StudentGradeView {
            ...
            chinese_book: student_grade.chinese_book,
            english_book: student_grade.english_book,
            math_book: student_grade.math_book,
            science_book: student_grade.science_book,
            social_studies_book: student_grade.social_studies_book,
