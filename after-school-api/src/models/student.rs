...
impl TryFrom<students::Model> for StudentView {
    ...
    fn try_from(student: students::Model) -> Result<Self, Self::Error> {
        Ok(StudentView {
            ...
            chinese_book: student.chinese_book,
            english_book: student.english_book,
            math_book: student.math_book,
            science_book: student.science_book,
            social_studies_book: student.social_studies_book,
